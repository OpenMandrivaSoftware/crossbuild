...
NEEDED="$LIBC:-crosscompilers ncurses:-cplusplus readline bash make ninja zlib-ng gzip bzip2 xz libb2 lz4 zstd file libarchive libtirpc:-gss libnsl libxcrypt gdbm lksctp-tools openssl pam:bootstrap attr acl lua:-pgo libgpg-error libgcrypt sqlite libcap expat pcre2 json-c libssh libunistring libidn2 libpsl curl:-gnutls:-mbedtls:-kerberos libmicrohttpd elfutils libbpf util-linux:bootstrap cracklib:-python libpwquality:-python x11-proto-devel:-python2 sltdl libxau libxcb x11-xtrans-devel libx11 libxkbfile xkbcomp dbus:-systemd tpm2-tss libpng:-pgo qrencode kmod gmp nettle:-pgo libtasn1 brotli:-pgo:-python libffi bash-completion-devel p11-kit:bootstrap unbound gnutls:-pgo icu libxml2:-pgo:-python wayland wayland-protocols-devel libxkbcommon glib2.0:-pgo:-gtkdoc:-introspection:-systemtap:-sysprof libseccomp python-pyelftools systemd:bootstrap pam popt libxrender libxext libXrandr vulkan-headers vulkan-loader mpfr libmpc isl binutils gcc python:-tkinter bubblewrap rpm z3 llvm:-mlir:-crosscrt grep sed gawk coreutils pkgconf kbd python:-tkinter filesystem pbzip2 rootcerts pigz:-pgo libxcvt xcb-util-renderutil xcb-util xcb-util-image xcb-util-wm xcb-util-keysyms pixman:-pgo libfontenc graphite2 freetype:-rsvg:-harfbuzz fontconfig liblzo cairo harfbuzz:-gir freetype:-rsvg libxfont2 kernel xkeyboard-config xkeyboard-config-devel crontabs libedit python-six lz4 setup basesystem perl lua libmd libbsd shadow xdg-utils which unzip groff:-x11 fuse e2fsprogs procps-ng psmisc time wget findutils patch rootfiles etcskel diffutils publicsuffix-list publicsuffix-list-dafsa libksba npth libassuan autoconf automake slibtool libtool cyrus-sasl:bootstrap:-mysql:-pgsql:-krb5 libevent openldap gnupg cmake:bootstrap meson m4 common-licenses distro-release hostname iputils less libutempter logrotate net-tools:-bluetooth libsecret:-gir pinentry:-qt6:-qt5:-gtk2:-gnome:-fltk debugedit xxhash dwz gdb:-python rpm-helper lsb-release ppl shared-mime-info go-srpm-macros python-packaging python-pkg-resources rust-srpm-macros rpmlint spec-helper zchunk libsolv check librepo yaml libmodulemd:-gir:-python cppunit libdnf dnf python-dnf dnf-data toml11 fmt sdbus-cpp dnf:-ruby desktop-file-utils libice libsm libxt libxmu xset xprop chrpath pam_userpass perl-srpm-macros libaio pyudev lvm2 argon2 cryptsetup systemd gettext:-check:-java:-csharp:-emacs run-parts pcre onig slang newt chkconfig perl-File-HomeDir libxdmcp libglvnd libxft fribidi pango:bootstrap rrdtool lm_sensors libdrm libunwind libxshmfence libxfixes libva libvdpau libxxf86vm mesa:-rust:-rusticl libepoxy tcp_wrappers libcap-ng audit libsepol libselinux:bootstrap libpciaccess x11-server perl-Module-Build systemtap:-avahi:-java python-parsing filesystem rgb gcc:-crosscompilers perl-File-Which libevdev abattis-cantarell-fonts plymouth mkcomposecache xauth efi-filesystem x11-font-alias x11-font-cursor-misc x11-font-misc-misc mkfontdir libfontenc mkfontscale hwdata mtdev libinput:bootstrap x11-driver-input-libinput fonts-ttf-dejavu fontpackages-filesystem dracut timezone duktape polkit:-gir satyr augeas bash-completion python-pybeam python-enchant python-magic pyxdg python-tomli python-pip libcomps glu libxi freeglut python-dnf-plugins-core dnf-plugins-core hunspell python-setuptools python-wheel python-tomli-w python-flit-core python-dateutil aspell python-construct python-zstandard python-systemd libsigc-2.0 glibmm2.4 libxmlpp hfst-ospell libvoikko hspell enchant2 mm-common perl-XML-Parser voikko-fi gptfdisk userspace-rcu multipath-tools sudo libusb usbutils sysfsutils dbus-broker"
